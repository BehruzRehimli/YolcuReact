...
const Type = () => {
    ...
    useEffect(() => {
        const getCountries = async () => {
            ...
            try {
                var datas = await axios.get(`http://bexarehimli-001-site1.htempurl.com/api/types/GetAdmin/${page}`, { headers: { "Authorization": token } })
    ...
    return (
        <div className="admin-container">
            <h2 className='text-start  crud-header-entity pb-3' >Type</h2>
            <div className='text-end me-3'>
                <Link className='btn btn-primary' to={"/admin/type/create"}>Create Type</Link>
            </div>
                                    ...
                                    <tr key={x.id}>
                                        ...
                                        <td><span className="text-success">
                                            ...
                                            <button onClick={async () => {
                                                var token = "Bearer " + adminToken
                                                try {
                                                    var datas = await axios.delete(`http://bexarehimli-001-site1.htempurl.com/api/Types/${x.id}`, { headers: { "Authorization": token } })
