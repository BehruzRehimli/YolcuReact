        ...
        <div className='admin-container'>
            ...
            <Formik>
                <Formik initialValues={{
                    ...
                    try {
                        var result = await axios.post("http://bexarehimli-001-site1.htempurl.com/api/brands", values, { headers: { "Authorization": headerToken } })
                    } catch (error) {
                        console.log(result);
                    ...
                    {({ values }) => (
                        <Form>
                            ...
                            <div className='d-flex'>
                                <Field type="text" className="login-input" name='name' placeholder="Brand Name..." />
                            </div>
