...
const Brand = () => {
    ...
    useEffect(() => {
        const getCountries = async () => {
            ...
            try {
                var datas = await axios.get(`http://bexarehimli-001-site1.htempurl.com/api/Brands/GetAdmin/${page}`, { headers: { "Authorization": token } })
                                    ...
                                    <tr key={x.id}>
                                        ...
                                        <td><span className="text-success">
                                            ...
                                            <button onClick={async () => {
                                                var token = "Bearer " + adminToken
                                                try {
                                                    var datas = await axios.delete(`http://bexarehimli-001-site1.htempurl.com/api/Brands/${x.id}`, { headers: { "Authorization": token } })
                                                    var datas = await axios.get("http://bexarehimli-001-site1.htempurl.com/api/Brands", { headers: { "Authorization": token } })
