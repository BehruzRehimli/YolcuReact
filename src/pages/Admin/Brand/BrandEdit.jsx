...
const BrandEdit = () => {
    ...
    useEffect(() => {
        const getCountry = async () => {
            ...
            try {
                var data = await axios.get(`http://bexarehimli-001-site1.htempurl.com/api/Brands/${id}`, { headers: { "Authorization": headerToker } })
                    ...
                    loader ?
                        <Formik>
                            <Formik enableReinitialize initialValues={{
                                ...
                                try {
                                    var result = await axios.put(`http://bexarehimli-001-site1.htempurl.com/api/Brands/${id}`, values, { headers: { "Authorization": headerToken } })
